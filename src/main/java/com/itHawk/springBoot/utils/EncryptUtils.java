...
public class EncryptUtils {
    ...
    public static void main(String[] args) {
        EncryptUtils se = new EncryptUtils();
        ...
        *//*
        ...
        System.out.println("根据输入的规则" + User.USER_ENC0DE_RULE + "解密后的明文是:" + se.AESEncode(User.USER_ENC0DE_RULE , "123456"));
    }
